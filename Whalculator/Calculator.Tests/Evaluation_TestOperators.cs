...
namespace Whalculator.Tests {
	...
	public class Evaluation_TestOperators {
		...
		public void TestEvaluateOperatorLiteral02() {
			var output = ExpressionBuilder.GetSolvableFromText("2+38");
			Assert.AreEqual(40, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral03() {
			var output = ExpressionBuilder.GetSolvableFromText("38+2+438");
			Assert.AreEqual(478, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral04() {
			var output = ExpressionBuilder.GetSolvableFromText("5-3");
			Assert.AreEqual(2, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}
		...
		public void TestEvaluateOperatorLiteral06() {
			var output = ExpressionBuilder.GetSolvableFromText("1+3-2");
			Assert.AreEqual(2, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral07() {
			var output = ExpressionBuilder.GetSolvableFromText("1*0");
			Assert.AreEqual(0, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}
		...
		public void TestEvaluateOperatorLiteral09() {
			...
			Assert.AreEqual(6, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral10() {
			var output = ExpressionBuilder.GetSolvableFromText("10*5*4");
			Assert.AreEqual(200, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral11() {
			var output = ExpressionBuilder.GetSolvableFromText("78*37583");
			Assert.AreEqual(2931474, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral12() {
			var output = ExpressionBuilder.GetSolvableFromText("10/1");
			Assert.AreEqual(10, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral13() {
			var output = ExpressionBuilder.GetSolvableFromText("10/0.5");
			Assert.AreEqual(20, output.GetDoubleValue(new ExpressionEvaluationArgs() { }));
		}

		[TestMethod]
		public void TestEvaluateOperatorLiteral14() {
			var output = ExpressionBuilder.GetSolvableFromText("27/3");
